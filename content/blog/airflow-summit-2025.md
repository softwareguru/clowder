...
# post thumb
images: ["images/blog/2025/as-card.jpg"]
draft: false
---
...
<div class=" mb-4">
  <div class="row">
    <div class="col-lg-4">
      <img src="/images/blog/2025/as-0.jpg" class="img-fluid">
    </div>
    <div class="col-lg-8">
    <p>The opening keynote unveiled Airflow 3.0, a milestone release that redefines how teams think about orchestration, introducing greater flexibility, performance, and observability. The message resonated: orchestration is no longer just about getting jobs to run on time, it’s about building intelligent, resilient systems that adapt as data, scale, and business needs evolve.</p>
    <p>Throughout the sessions, that idea echoed in every conversation. Talks covered everything from distributed DAG execution to hybrid-cloud orchestration, AI-powered workflows, and real-time analytics.</p>
    <p>In the hallways, people huddled over laptops comparing setups, debated DAG dependency strategies, and shared lessons learned from running Airflow at scale. In workshops, newcomers built their first pipelines under the guidance of core contributors. Between sessions, spontaneous meetups turned into collaborations, and local user groups found new ways to connect their regional communities to the global one.</p>
    </div>
  </div>
</div>
...
<div class="container mb-4">
  <div class="row">
    <div class="col-lg-6">
      <img src="/images/blog/2025/as-1.jpg" class="img-fluid">
    </div>
    <div class="col-lg-6">
      <img src="/images/blog/2025/as-2.jpg" class="img-fluid">
    </div>
  </div>
</div>
